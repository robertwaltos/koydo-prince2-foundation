...
export const metadata: Metadata = {
  title: "Learn — PRINCE2 Foundation Practice",
  description: "Study and practice for PRINCE2 Foundation. Choose your subject and start preparing.",
};
