...
export const metadata: Metadata = {
  title: "Pricing — Prince2 Foundation Premium",
  description: "Unlock unlimited Prince2 Foundation practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=prince2-foundation&cadence=annual`;
